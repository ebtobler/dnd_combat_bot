...
class TestStringParser(TestCase):
    ...
    def test_str_to_dice_function(self):
        ...
        self.assertEqual(Dice.d6, result[1])
    ...
    def test_parse_damage_string(self):
        ...
        expected_damage = DamageData((10, Dice.d12), 18, 'force')
    ...
    def test_parse_player_attack_string(self):
        ...
        first_damage = DamageData((2, Dice.d6), 3, 'slashing')
        second_damage = DamageData((1, Dice.d4), 1, 'fire')
